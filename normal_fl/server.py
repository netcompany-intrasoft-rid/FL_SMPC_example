...
class NormalFLServer(fl.server.strategy.FedAvg):
    """
    ...
    def aggregate_weights(self, weights_results: List[List[np.ndarray]],
    ...
    def aggregate_fit(self,
        ...
        aggregated_weights = self.aggregate_weights(weights_results, num_samples)
